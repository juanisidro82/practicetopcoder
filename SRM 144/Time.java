...
public class Time {
	public String whatTime(int seconds) {
        ...
        String timescreen = hours + ":" + minutes + ":" + seconds;
		return timescreen;
	}
...
// CUT begin
	...
	static class Reader {
        private static final String dataFileName = "Time.sample";
