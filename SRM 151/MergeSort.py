...
def mergeSort(a, ncomp):
    ...
    b = a[0:k]
    c = a[k:n]
    sb, ncomp = mergeSort(b, ncomp)
    sc, ncomp = mergeSort(c, ncomp)
    a, ncomp = merge(sb, sc, ncomp)
    return (a, ncomp)
...
def run_tests():
    sys.stdout.write("MergeSort (1000 Points)\n\n")
    ...
    with open("MergeSort.sample", "r") as f:
        while True:
            label = f.readline()
